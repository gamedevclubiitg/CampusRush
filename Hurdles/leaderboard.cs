...
public class leaderboard : MonoBehaviour {
    ...
    public void Wake() {
        ...
        WWWForm leaderBoardForm = DBops.GetLeaderboardForm("hurdle", limitToShow.ToString(), "0");
        Debug.Log("Getting Hurdles Leaderboard");
    ...
    private void CreateHighscoreEntryTransform(HighscoreEntry highscoreEntry, Transform container, List<Transform> transformList) {
        ...
        entryRectTransform.anchoredPosition = new Vector2(0,180 -templateHeight * transformList.Count);
